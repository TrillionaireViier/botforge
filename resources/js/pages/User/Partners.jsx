  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-gray-900">Кабинет партнера</h1>
        <div className="bg-yellow-300 border-2 border-black px-4 py-2 rounded-full font-bold flex items-center shadow-[2px_2px_0_0_rgba(0,0,0,1)]">
          <Award className="w-5 h-5 mr-2" /> Золотой статус (20% Комиссия)
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-[4px_4px_0_0_rgba(0,0,0,1)] border-2 border-black flex items-center space-x-4">
          ...
          <div>
            <p className="text-sm font-bold text-gray-500">Всего рефералов</p>
        ...
        <div className="bg-white p-6 rounded-xl shadow-[4px_4px_0_0_rgba(0,0,0,1)] border-2 border-black flex items-center space-x-4">
          ...
          <div>
            <p className="text-sm font-bold text-gray-500">Всего заработано</p>
        ...
        <div className="bg-white p-6 rounded-xl shadow-[4px_4px_0_0_rgba(0,0,0,1)] border-2 border-black flex items-center space-x-4">
          ...
          <div>
            <p className="text-sm font-bold text-gray-500">Клики по ссылке</p>
      ...
      <div className="bg-white p-8 rounded-xl shadow-[4px_4px_0_0_rgba(0,0,0,1)] border-2 border-black">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 flex border-2 border-black rounded-lg overflow-hidden">
            ...
            >
              {copied ? 'Скопировано!' : <><Copy className="w-4 h-4 inline mr-2" /> Копировать ссылку</>}
            </button>
          </div>
      ...
      <div className="bg-white rounded-xl shadow-[4px_4px_0_0_rgba(0,0,0,1)] border-2 border-black overflow-hidden mt-6">
        <div className="p-6 border-b-2 border-black">
          <h2 className="text-xl font-bold">Последние выплаты</h2>
        </div>
            ...
            <tbody className="divide-y divide-gray-200">
              {[1, 2, 3].map((i) => (
                <tr key={i} className="hover:bg-gray-50">
                  <td className="px-6 py-4 font-bold text-gray-600">{15 - i} Окт 2025</td>
                  <td className="px-6 py-4 font-bold text-green-600">+$245.00</td>
                  <td className="px-6 py-4">
                    <span className="bg-green-100 text-green-800 px-2 py-1 rounded text-xs font-bold border-2 border-black">Выплачено</span>
                  </td>
