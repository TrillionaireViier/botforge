...
export default function AdminLayout() {
  ...
  const navItems = [
    ...
    { path: "/admin/bots", name: "БОТЫ", icon: Bot },
    { path: "/admin/revenue", name: "СДЕЛКИ", icon: DollarSign },
    { path: "/admin/tickets", name: "ПОДДЕРЖКА", icon: LifeBuoy },
    { path: "/admin/settings", name: "НАСТРОЙКИ", icon: Key },
    { path: "/admin/kyc-aml", name: "KYC / AML", icon: Shield },
    { path: "/admin/ab-testing", name: "A/B ТЕСТЫ", icon: Activity },
    { path: "/admin/affiliate", name: "ПАРТНЕРКА", icon: Users },
    { path: "/admin/seo", name: "SEO", icon: Search },
    { path: "/admin/promocodes", name: "ПРОМОКОДЫ", icon: Tag },
    { path: "/admin/payouts", name: "ВЫПЛАТЫ", icon: DollarSign },
    { path: "/admin/api-logs", name: "ЛОГИ API", icon: Database },
    { path: "/admin/cron-jobs", name: "CRON ЗАДАЧИ", icon: Clock },
    { path: "/admin/exchange-status", name: "БИРЖИ", icon: Activity },
    { path: "/admin/knowledge-base", name: "БАЗА ЗНАНИЙ", icon: BookOpen },
    { path: "/admin/campaigns", name: "КАМПАНИИ", icon: Mail },
    { path: "/admin/limits", name: "ЛИМИТЫ", icon: Shield },
    { path: "/admin/backups", name: "БЭКАПЫ", icon: Save },
    { path: "/admin/support-audit", name: "АУДИТ", icon: Eye },
    { path: "/admin/localization", name: "ЯЗЫКИ", icon: Globe },
    { path: "/admin/themes", name: "ТЕМЫ", icon: Palette },
    { path: "/admin/funnels", name: "ВОРОНКИ", icon: Filter },
    { path: "/admin/surveys", name: "ОПРОСЫ", icon: PieChart },
    { path: "/admin/widgets", name: "ВИДЖЕТЫ", icon: LayoutTemplate },
    { path: "/admin/error-tracking", name: "ОШИБКИ", icon: AlertTriangle },
    { path: "/admin/ip-blacklist", name: "ЧЕРНЫЙ СПИСОК", icon: Shield },
    { path: "/admin/social-scheduler", name: "СОЦСЕТИ", icon: Calendar },
    { path: "/admin/segmentation", name: "СЕГМЕНТЫ", icon: Users },
    { path: "/admin/financial-reports", name: "ФИНАНСЫ", icon: BarChart },
    { path: "/admin/security-log", name: "БЕЗОПАСНОСТЬ", icon: Shield },
    { path: "/admin/churn-stats", name: "ОТТОК", icon: Users },
    { path: "/admin/bot-limits", name: "ЛИМИТЫ БОТОВ", icon: Bot },
    { path: "/admin/events", name: "СОБЫТИЯ", icon: Calendar },
    { path: "/admin/file-manager", name: "ФАЙЛЫ", icon: Database },
    { path: "/admin/plugins", name: "ПЛАГИНЫ", icon: Bot },
  ];
