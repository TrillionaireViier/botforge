    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-[4px_4px_0_0_rgba(0,0,0,1)] border-2 border-black">
          ...
          <div className="mt-4 flex items-center text-sm font-bold text-green-600">
            <ArrowUpRight className="w-4 h-4 mr-1" /> +12.5% с прошлой недели
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-[4px_4px_0_0_rgba(0,0,0,1)] border-2 border-black">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-sm font-bold text-gray-500">Активные трейдеры</p>
          ...
          <div className="mt-4 flex items-center text-sm font-bold text-green-600">
            <ArrowUpRight className="w-4 h-4 mr-1" /> +5.2% с прошлой недели
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-[4px_4px_0_0_rgba(0,0,0,1)] border-2 border-black">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-sm font-bold text-gray-500">Доход платформы</p>
          ...
          <div className="mt-4 flex items-center text-sm font-bold text-green-600">
            <ArrowUpRight className="w-4 h-4 mr-1" /> +18.1% с прошлой недели
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-[4px_4px_0_0_rgba(0,0,0,1)] border-2 border-black">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-sm font-bold text-gray-500">Средний ROI ботов</p>
          ...
          <div className="mt-4 flex items-center text-sm font-bold text-green-600">
            <ArrowUpRight className="w-4 h-4 mr-1" /> +2.4% с прошлой недели
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-[4px_4px_0_0_rgba(0,0,0,1)] border-2 border-black h-80 flex flex-col items-center justify-center">
           <h3 className="font-bold text-xl mb-4 self-start">Тренд объемов торгов</h3>
        ...
        <div className="bg-white p-6 rounded-xl shadow-[4px_4px_0_0_rgba(0,0,0,1)] border-2 border-black">
          <h3 className="font-bold text-xl mb-4">Топ ботов по доходности</h3>
